...
VIDEO = "week-11/congratulation.mp4"
...
USE_THAI = True
FONT_PATH = "week-11/NotoSansThai-Regular.ttf"   # วางไฟล์ฟอนต์ไทยในโฟลเดอร์นี้
FONT_SIZE = 26
...
def main():
    ...
    while True:
        ...
        extra_th = "นาย นวนนท์ กุสลานนท์ 664245009"      # เปลี่ยนเป็นชื่อคนได้ เช่น "ชื่อ: นนท์"
